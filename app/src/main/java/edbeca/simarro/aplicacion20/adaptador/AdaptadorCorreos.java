package edbeca.simarro.aplicacion20.adaptador;
...
import edbeca.simarro.aplicacion20.pojo.Correo;
...
public class AdaptadorCorreos extends ArrayAdapter<Correo> {
    ...
    public AdaptadorCorreos(Fragment context, ArrayList<Correo> datos) {
        super(context.getActivity(), R.layout.layout_element_lista, datos);
        this.context = context.getActivity();
        this.datos = datos;
    }
    public View getView(int position, View convertView, ViewGroup parent) {
        LayoutInflater inflater = context.getLayoutInflater();
        View item = inflater.inflate(R.layout.layout_element_lista, null);
